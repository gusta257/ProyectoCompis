...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # similarly creating save action
        code_action = QAction("Codigo", self)
        code_action.setStatusTip("Code")
        code_action.triggered.connect(self.show_new_window)
        file_menu.addAction(code_action)
        file_toolbar.addAction(code_action)
    ...
    def show_new_window(self,cheked):
        ...
        if self.w.isVisible():
            ...
            for i in lines:
                self.w.editor.insertPlainText(i)
